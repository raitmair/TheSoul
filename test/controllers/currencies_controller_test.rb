...
class CurrenciesControllerTest < ActionController::TestCase
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post :create, currency: { create: @currency.create, destroy: @currency.destroy, name: @currency.name, update: @currency.update }
    end
  ...
  test "should update currency" do
    patch :update, id: @currency, currency: { create: @currency.create, destroy: @currency.destroy, name: @currency.name, update: @currency.update }
    assert_redirected_to currency_path(assigns(:currency))
  end
